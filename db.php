<?php 
    ...
    $product1 = new Food("Monge per cani", "9.99", "croccantini gustosi al manzo", "https://www.gardenbedettishop.com/8217-large_default/crocchette-per-cani-monge-adult-salmone-e-riso-12-kg.jpg", "Cibo");
    $product1Category = new Category("Cani", "<i class='fa-solid fa-dog'></i>");
    $product1->category = $product1Category;

    $product2 = new Food("Monge per gatti", "10.99", "croccantini gustosi al manzo", "https://www.bestprato.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/m/o/monge-natural-superpremium-monoprotein-per-gatti-adulti-sterilizzati-trota-1_5-kg.jpg", "Cibo");
